...
namespace BingoSyncExtension
{
    public static class GameModesManager
    {
        ...
        private static void SetupVanillaGoals()
        {
            ...
            _vanillaGoals["Kill 4 Mimics"].exclusions = ["Save the 5 grubs in Deepnest", "Save the 7 grubs in Crystal Peaks"];
            ...
            _vanillaGoals["Save the 7 grubs in Crystal Peaks"].exclusions = ["Kill 4 Mimics"];
